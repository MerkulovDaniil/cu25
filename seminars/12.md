...
## Задача 1
::: {.callout-question title="Найти субградиент функции $f$"}

Найти субградиент функции
$$ f(x) = -\sqrt{x} $$
...
## Задача 2
::: {.callout-question title="Найти субградиент суммы"}

Найти субградиент функции $f(x) + g(x)$, если
