...
format: 
    ...
    beamer-cu:
      ...
      header-includes:
        - \newcommand{\cover}{../files/БАК_Методы вып_оптимизации_презентация_5.pdf}
    beamer-cu-maga:
      pdf-engine: xelatex
      aspectratio: 169
      fontsize: 9pt
...
Пусть $x^*$, $(\lambda^*, \nu^*)$ является решением математической задачи программирования. Пусть также функции $f_0, f_i, h_i$ дифференцируемы.
...
![Иллюстрация](../files/adversarial_attacks_cat_ex.pdf){width=100}
