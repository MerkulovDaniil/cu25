...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-color!10!white, opacitybacktitle=0.6, arc=.35mm, toptitle=1mm, rightrule=.15mm, opacityback=0, titlerule=0mm, breakable, title=\textcolor{quarto-callout-color}{\faInfo}\hspace{0.5em}{Гладкий сильно выпуклый случай}, colframe=quarto-callout-color-frame, coltitle=black, bottomtitle=1mm, left=2mm, toprule=.15mm, bottomrule=.15mm, colback=white, leftrule=.75mm]
