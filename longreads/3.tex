...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, breakable, toptitle=1mm, opacityback=0, title=\textcolor{quarto-callout-color}{\faInfo}\hspace{0.5em}{Question}, bottomrule=.15mm, colframe=quarto-callout-color-frame, opacitybacktitle=0.6, colbacktitle=quarto-callout-color!10!white, coltitle=black, left=2mm, bottomtitle=1mm, arc=.35mm, titlerule=0mm, toprule=.15mm, leftrule=.75mm, colback=white]
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{ad_mixed.pdf}}
