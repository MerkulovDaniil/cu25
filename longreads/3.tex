...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, arc=.35mm, leftrule=.75mm, colbacktitle=quarto-callout-color!10!white, bottomrule=.15mm, toprule=.15mm, left=2mm, bottomtitle=1mm, toptitle=1mm, colframe=quarto-callout-color-frame, breakable, title=\textcolor{quarto-callout-color}{\faInfo}\hspace{0.5em}{Question}, titlerule=0mm, colback=white, coltitle=black, opacitybacktitle=0.6, opacityback=0]
