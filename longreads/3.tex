...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, titlerule=0mm, rightrule=.15mm, colbacktitle=quarto-callout-color!10!white, coltitle=black, opacitybacktitle=0.6, opacityback=0, toptitle=1mm, arc=.35mm, breakable, colframe=quarto-callout-color-frame, colback=white, title=\textcolor{quarto-callout-color}{\faInfo}\hspace{0.5em}{Question}, bottomtitle=1mm, bottomrule=.15mm, toprule=.15mm, left=2mm]
