...
Обратите внимание, что если мы возьмем единичную матрицу, умноженную на константу $B_k = \alpha_k I_n$ в качестве $B_k$ на каждом шаге, мы получим точно метод градиентного спуска.
